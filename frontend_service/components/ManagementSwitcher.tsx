...
export default function ManagementSwitcher() {
  ...
  const currentValue: "user" | "device" =
    pathname && pathname.includes("/devices") ? "device" : "user";
    ...
    <div style={containerStyle}>
      {isAdmin ? (
        <button
          ...
          style={getButtonStyle(currentValue === "user")}
        >
          <PersonIcon
            sx={{ fontSize: 16 }}
            style={iconStyle(currentValue === "user")}
          />
      ...
      <button
        ...
        style={getButtonStyle(
          !isAdmin || currentValue === "device" ? true : false
        )}
      >
        <MemoryIcon
          sx={{ fontSize: 16 }}
          style={iconStyle(currentValue === "device")}
        />
